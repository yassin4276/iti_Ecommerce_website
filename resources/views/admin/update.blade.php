...
<body>
    ...
    <div class="apply">
        <form action="{{(route('editproduct',$products->id))}}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <input type="text" class="text" name="name" value="{{$products->name}}" placeholder="Enter product name">
            <br>
            <input type="text" class="text" name="information" value={{$products->information}} placeholder="Enter product information">
            <br>
            ...
            <br>
            <input type="number" class="text" name="price" value="{{$products->price}}" placeholder="Enter product price">
            <br>
