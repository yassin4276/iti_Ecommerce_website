...
<body>
    ...
    <br>
    <div class="apply">
        <form action="<?php echo e(route('usereditprofile',$profile->id)); ?>" method="POST" enctype="multipart/form-data">
...
</html><?php /**PATH D:\project\ShoeStore-app\resources\views/user/editprofile.blade.php ENDPATH**/ ?>