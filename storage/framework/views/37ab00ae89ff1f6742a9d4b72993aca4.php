...
<body>
    ...
    <section class="cards" id="shoes">
        ...
        <?php if(str_contains(strtolower($product->name),strtolower($name))): ?>
            <div class="content">
            <a href=""><div class="card">
                ...
                <div class="information">
                    ...
                    <br>
                    <form action="<?php echo e(route('addtocart',['userid'=>session('userid'),'productid'=>$product->id])); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\project\ShoeStore-app\resources\views/user/search.blade.php ENDPATH**/ ?>